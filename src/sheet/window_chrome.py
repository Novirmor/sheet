...
def build_menus(window: MainWindow) -> None:
    ...
    sheet_menu.addSeparator()
    sheet_menu.addAction(window.freeze_panes_action)
    sheet_menu.addActions([window.autofit_columns_action, window.autofit_rows_action])
    sheet_menu.addSeparator()
    sheet_menu.addActions([window.hide_rows_action, window.hide_columns_action])
    sheet_menu.addActions([window.unhide_rows_action, window.unhide_columns_action])
    sheet_menu.addSeparator()
    sheet_menu.addAction(window.clear_filters_action)
    sheet_menu.addSeparator()
